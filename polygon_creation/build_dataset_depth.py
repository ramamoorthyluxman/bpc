...
root_output_path = "/home/rama/bpc_ws/bpc/datasets/ipd_train_depth"  # Root output folder
...
for dataset_folder in dataset_folders:
    ...
    for cam_id in [1, 2, 3]:
        ...
        for scene_id in tqdm(scene_ids, desc=f"  Camera {cam_id}"):
            ...
            src_img_path = os.path.join(dataset_path, f"depth_cam{cam_id}", f"{int(scene_id):06d}.png")
            dst_img_path = os.path.join(output_path, "images", f"{int(scene_id):06d}_cam{cam_id}.png")
            ...
            annotation = {
                "image_path": f"images/{int(scene_id):06d}_cam{cam_id}.png",
                "height": height,
                "width": width,
                "masks": []
            }
