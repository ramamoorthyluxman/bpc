...
if __name__ == '__main__':
    img1 = cv2.imread("/home/rama/bpc_ws/bpc/pointcloud_registration/output/reference_images/ref_01_obj_000018_01_cam1_polygon.png")
    img2 = cv2.imread("/home/rama/bpc_ws/bpc/pointcloud_registration/output/test_images/test_02_obj_000018_polygon.png")
    ...
    start = time.time()
    matches_gms = matchGMS(img1.shape[:2], img2.shape[:2], kp1, kp2, matches_all, withScale=False, withRotation=True, thresholdFactor=6)
    end = time.time()
    ...
    cv2.imwrite("/home/rama/bpc_ws/bpc/pointcloud_registration/GMS-Feature-Matcher-master/data/result.jpg", output)
    # cv2.waitKey(0)
